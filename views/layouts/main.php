        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="ecommerce-products.html" key="t-products">Add Coupon</a></li>
                        <li><a href="ecommerce-product-detail.html" key="t-product-detail">Coupon List</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="ecommerce-products.html" key="t-products">Add Area</a></li>
                        <li><a href="ecommerce-orders.html" key="t-orders">Area List</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="ecommerce-products.html" key="t-products">Add Notification</a></li>
                        <li><a href="ecommerce-orders.html" key="t-orders">Notification List</a></li>
                    </ul>
                </li>
