                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <img src="/assets/images/<?= $bimg; ?>" class="img-thumbnail" alt="">
                                                </td>
                                                <td align="center">
                                                    <h5 class="font-size-14 mb-1"><?= $cid; ?></h5>
                                                </td>
                                                <td align="center">
                                                    <div>
                                                        <h5 class="font-size-14 mb-1"><?= $sid; ?></h5>
                                                    </div>
                                                </td>
                                                <td align="center">
...
<div class="modal fade hide" role="dialog" id="editModal" aria-labelledby="editModalLabel" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/bannerlist/update" method="Post" id="updateBannerList" enctype="multipart/form-data">
...
<script>
    $(document).ready(
        function() {
            $(document).on("click", ".editbanner", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#subcategory").find(":selected").text(data[0].name);
            ...
            $("#updateBannerList").on("submit", function() {
                if ($("#categoryname").val() == "") {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        data: $("#updateBannerList").serialize(),
                        success: function(data) {
                            $("#editModal").modal("hide");
